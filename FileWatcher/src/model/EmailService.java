...
public class EmailService {
     ...
     */
    public EmailService(final String theSenderEmail, final String theSenderPassword) {
     ...
     */
    public void sendEmailWithAttachment(final String theRecipient, final String theSubject,
                                        final String theMessage, final File theAttachment)
            throws MessagingException, IOException {

        // Yahoo Mail SMTP properties
