...
public class QueryManager {
     ...
     */
    public List<FileEvent> queryByDateRange(LocalDateTime theStart, LocalDateTime theEnd) {
     ...
     * @return list of matching FileEvents
     */
    public List<FileEvent> queryByExtension(String theExtension) {
     ...
     * @return list of matching FileEvents
     */
    public List<FileEvent> queryByEventType(EventType theType) {
     ...
     * @return list of matching FileEvents
     */
    public List<FileEvent> queryByDirectoryPath(String theDirectoryPath) {
